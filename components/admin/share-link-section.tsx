          ...
          {loading ? (
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-3 p-3 bg-purple-50 dark:bg-purple-900/20 border border-purple-200 dark:border-purple-800 rounded-xl">
                ...
                <div className="flex-1 min-w-0">
                  <div className="text-sm font-medium text-purple-900 dark:text-purple-100">{t('shareResultsTitle')}</div>
                  <div className="text-xs text-purple-600 dark:text-purple-400">{t('shareResultsDescription')}</div>
                </div>
                <button
                  onClick={async () => {
                    if (!shareUrl) return
                  ...
                  className="shrink-0 px-3 py-1.5 text-xs font-medium rounded-lg bg-purple-600 hover:bg-purple-700 text-white transition-colors"
                >
